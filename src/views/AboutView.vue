...
const toggleSubmenu = menu => {
  ...
  for (const key in isSubmenuVisible.value) {
    isSubmenuVisible.value[key] = false
  }
  isSubmenuVisible.value[menu] = !isSubmenuVisible.value[menu]
}

// Watch for dark mode changes if necessary
...
.circle {
  width: 6px;
  height: 6px;
  background-color: #4a90e2; /* Adjust color for the circle */
  border-radius: 50%;
}
</style>
